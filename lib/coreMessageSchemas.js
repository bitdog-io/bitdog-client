...
function CoreMessageSchemas()
{
    ...
    .addNumberProperty('freeMem', 0, {}, 'The amount of free device memory in bytes.','Free Memory', 'Bytes')
    .addNumberProperty('uptime', 0, {}, 'The system uptime in seconds.','Up Time', 'Seconds')
    .addNumberProperty('loadAvg1min', 0, {},'The cpu load average for the last minute.','One Minute Load Average', 'Percent')
    .addNumberProperty('loadAvg5min', 0, {},'The cpu load average for the last five minutes.','Five Minute Load Average', 'Percent')
    .addNumberProperty('loadAvg15min', 0, {}, 'The cpu load average for the last fifteen minutes.', 'Five Minute Load Average', 'Percent')
    .addNumberProperty('totalMem', 0, {}, 'The total amount of device memory in bytes.', 'Total Memory', 'Bytes')
    .addNumberProperty('uptimeProcess', 0, {}, 'The node.js process uptime in seconds.', 'Process Uptime', 'Seconds');
