...
function CoreMessageSchemas()
{
    ...
    var _pingMessageSchema = bitdog.createMessageSchema(constants.MESSAGE_SCHEMA_PING);
    ...
    this.__defineGetter__('pingMessageSchema', function () {
        return _pingMessageSchema;
    });
