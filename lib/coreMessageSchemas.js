...
function CoreMessageSchemas()
{
    ...
    .addNumberProperty('freeMem', 0, {}, 'The amount of free device memory in bytes.','Free Memory')
    .addNumberProperty('uptime', 0, {}, 'The system uptime in seconds.','Up Time')
    ...
    .addNumberProperty('totalMem', 0, {}, 'The total amount of device memory in bytes.', 'Total Memory')
    .addNumberProperty('uptimeProcess', 0, {}, 'The node.js process uptime in seconds.', 'Process Uptime');
