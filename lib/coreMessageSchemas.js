...
function CoreMessageSchemas()
{
    ...
    var _redirectMessageSchema = bitdog.createMessageSchema(constants.MESSAGE_SCHEMA_REDIRECT)
    ...
    this.__defineGetter__('redirectMessageSchema', function () {
        return _redirectMessageSchema;
    });
