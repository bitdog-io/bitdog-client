...
function WebProcess () {
    ...
    this.start = function () {
        if (!_isStarted && _childProcess == null) {
            ...
            logger.logProcessEvent(constants.LOG_PROCESS_WEBADMIN,'Process started at pid: ' + _childProcess.pid);
    ...
    function onDisconnected() {
        logger.logProcessEvent(constants.LOG_PROCESS_WEBADMIN,'Process disconnected');
    }
