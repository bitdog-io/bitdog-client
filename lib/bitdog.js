...
Bitdog.prototype.addCommand = function (name, messageSchema, executeCallback, startCallback, stopCallback, hidden, displayName) {
    return _session.addCommand(name, messageSchema, executeCallback, startCallback, stopCallback, hidden, displayName);
};

Bitdog.prototype.addDataCollector = function (name, messageSchema, intervalMilliseconds, collectCallback, hidden, displayName) {
    return _session.addDataCollector(name, messageSchema, intervalMilliseconds, collectCallback, hidden, displayName);
};

Bitdog.prototype.addData = function (name, messageSchema, hidden, displayName) {
    return _session.addDataCollector(name, messageSchema, -1, undefined, hidden, displayName);
};
...
Bitdog.prototype.getHubUrl = function (resultCallback, authorizationFailedCallback, errorCallback) {
    return _session.getHubUrl(resultCallback, authorizationFailedCallback, errorCallback);
};

Bitdog.prototype.getVideoHubUrl = function (resultCallback, authorizationFailedCallback, errorCallback) {
    return _session.getVideoHubUrl(resultCallback, authorizationFailedCallback, errorCallback);
};

Bitdog.prototype.getFileAssetUrl = function (resultCallback, authorizationFailedCallback, errorCallback) {
    return _session.getFileAssetUrl(resultCallback, authorizationFailedCallback, errorCallback);
};
