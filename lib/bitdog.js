...
bitdog.prototype.addCommand = function (name, messageSchema, executeCallback, startCallback, stopCallback) {
    return _session.addCommand(name, messageSchema, executeCallback, startCallback, stopCallback);
};

bitdog.prototype.addDataCollector = function (name, messageSchema, intervalMilliseconds, collectCallback) {
    return _session.addDataCollector(name, messageSchema, intervalMilliseconds, collectCallback);
};
...
bitdog.prototype.addQuestion = function (questionText,answerText) {
    return _session.addQuestion(questionText, answerText);
};
...
bitdog.prototype.on = function (event, listener) {
    return _session.on(event, listener);
};
