...
function Constants()
{
    ...
    this.MESSAGE_SCHEMA_QUESTION = 'bitdog-question';
    ...
    this.MESSAGE_SCHEMA_REDIRECT = "bitdog-redirect";

    /////////////////// Hub Information ///////////////////
    this.HUB_NAME = 'NodeHub';
    this.AGENT_HUB_NAME = 'AgentHub';
    this.CENTRAL_HUB_URL = 'wss://hub.bitdog.io/signalr';
    this.CENTRAL_REGISTER_URL = "https://preview.bitdog.io/realm/registernode";
    /////////////////// Data Types ////////////////////////
