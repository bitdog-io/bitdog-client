...
function Constants() {
    ...
    this.MESSAGE_SCHEMA_PING = 'bitdog-ping';
    ...
    this.HUB_GETFILEASSETURL_PATH = '/realm/getfileasseturl';
    /////////////////// Data Types ////////////////////////
    ...
    this.LOG_JSON = 'logging:log_json';
    this.PERFORMANCE_POLL_SECONDS = 'data_collection:performace_poll_seconds';
    this.AUTOMATIONS_LOCATION = 'automation:location';
    
    
    ////////////////// LOGGING CATEGORY //////////////////
    this.HELLOTXT = 'Connected to Bitdog, welcome! Download the Bitdog Remote mobile app to control this node and monitor what it is doing.';
