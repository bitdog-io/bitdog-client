...
var cwdConfigFilePath = path.resolve(process.cwd(), constants.CONFIGURATION_FILENAME);
var cwdLogFilePath = path.resolve(process.cwd(), constants.LOG_FILE_NAME);
...
function Configuration() {
    ...
    try {
        _nconf.use('file', { file: cwdConfigFilePath });
    }
    catch (ex) {
        console.log(ex);
    }
