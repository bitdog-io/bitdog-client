...
function SessionEngine() {
    ...
    this.addDataCollector('bd-commandResult', this._coreMessageSchemas.commandResultMessageSchema, -1, function (message, configuration, logger) {
    }, true);
...
SessionEngine.prototype.postNodeConfiguration = function (configuration, successCallback, errorCallback) {
    var self = this;
    var port = null;
    var protocol = null;
    ...
    var request = {
        ...
        configurations: configuration.d
    };
    ...
    var parsedUrl = url.parse(bitdogClient.constants.CENTRAL_URL + '/realm/saveNodeConfiguration');
        ...
        response.on('end', function () {
            ...
            if (this.statusCode == 200 && responseString.length > 1) {
                ...
                try {
                    ...
                    bitdogClient.logger.logProcessEvent(constants.LOG_PROCESS_ZWAVE, 'Error parsing JSON from saveNodeConfiguration:', e);
                }
...
SessionEngine.prototype.sendCommandResult = function (commandResult) {
    this.sendData('bd-commandResult', this._coreMessageSchemas.commandResultMessageSchema, function (message) {
