...
function SessionEngine() {
    ...
    if (typeof seconds != typeof undefined && seconds != null && seconds != 0) {
        this.addDataCollector('bd-performance', this._coreMessageSchemas.performanceMessageSchema, 10000 * seconds, this.collectPerformance.bind(this));
    }
};
...
SessionEngine.prototype.collectPerformance = function (message, configuration, logger) {
    ...
    message.loadAverage1min = loads[0]; 
    message.loadAverage5min = loads[1];
    message.loadAverage15min = loads[2];
