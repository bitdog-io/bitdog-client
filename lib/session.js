...
SessionEngine.prototype.postNodeConfiguration = function (configurationJson, successCallback, errorCallback) {
    var self = this;
    var port = null;
    var protocol = null;
    ...
    var request = {
        ...
        configurations: configurationJson.d
    };
        ...
        response.on('end', function () {
            ...
            if (this.statusCode == 200 && responseString.length > 1) {
                ...
                try {
                    ...
                    logger.logProcessEvent(constants.LOG_PROCESS_ZWAVE, 'Error parsing JSON from saveNodeConfiguration:', e);
                }
