...
function UserCodeProcess () {
    ...
    this.start = function () {
        if (!_isStarted && _childProcess == null) {
            ...
            logger.logProcessEvent(constants.LOG_PROCESS_USERCODE,'Process started at pid: ' + _childProcess.pid);
    ...
    function onDisconnected() {
        logger.logProcessEvent(constants.LOG_PROCESS_USERCODE, 'Process disconnected');
    }
